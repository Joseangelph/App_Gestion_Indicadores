...
const ListaComponentes = () => {
    ...
    const handleShow = (id) => {
      navegar(`/mostrarComponentes/${id}`); // Redirigir a la página de mostrar con el ID del Componente
    };
    ...
    const columns = [
        ...
        {field: 'destino_impacto_nombre', headerName: 'Destino de impacto', width: 350, editable: false },
        {
          field: 'actions',
          headerName: 'Acciones',
          width: 130,
